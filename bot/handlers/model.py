...
AVAILABLE_MODELS = {
    ...
    "gpt-image-1.5": {
        "name": "GPT Image 1.5",
        "description": "Улучшенная модель. Лучшее качество.",
    },
    "seedream-4-5": {
        "name": "SeeDream 4.5",
        "description": "Новейшая модель BytePlus. Отличное качество, быстрая генерация и редактирование. Хорошо сохраняет лица.",
    },
}
